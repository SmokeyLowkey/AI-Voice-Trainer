export const sendPredefinedMessage = async (setAudioChunks: (chunks: string[]) => void) => {
    try {
      const response = await fetch('/api/gpt', {
        ...
        body: JSON.stringify({
          transcription: "Welcome to the app... Here an AI model will roleplay customer interactions with you and score you based on accuracy and flow of the call. Make sure you follow your call service guidelines! So... ready to get started? press the button!",
          type: 'predefined',
        }),
      });
